...
* **Tailwind via CDN** during development. No build step.
...
* No `font-600` or `font-700` Tailwind classes — use `font-semibold` / `font-bold`
...
* Overlay: `rgba(0,0,0,0.45)` as default — adjust per photo.
...
* Link to Google Maps + "Leave a review" CTA.
...
- [ ] No `font-600` / `font-700` Tailwind classes
...
*Taste Skill — Restaurant Edition v1.0*
